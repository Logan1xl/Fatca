...
class Report extends Model
{
    ...
    public function getStatusBadgeAttribute(): string
    {
        return match ($this->status) {
            ...
            'analyzing' => '<span class="badge bg-cbc-gold bg-opacity-10 text-cbc-gold compliance-badge"><i class="fas fa-spinner fa-spin me-1"></i>Analyse</span>',
            ...
            'corrected' => '<span class="badge bg-cbc-gold bg-opacity-10 text-cbc-gold compliance-badge"><i class="fas fa-wrench me-1"></i>Corrigé</span>',
